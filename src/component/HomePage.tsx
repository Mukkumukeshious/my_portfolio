...
const Hero = () => {
  return (
    <div>
      <section className="w-full pt-20 bg-black text-white py-16 px-6 md:px-20 flex flex-col-reverse md:flex-row items-center justify-between gap-10 relative overflow-hidden">
        <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-3 justify-center md:justify-start pt-4 text-sm font-medium">
            <a
              className="bg-[#0e76a8] px-4 py-2 rounded-md"
              href="https://www.linkedin.com/in/mukesh-chaudhary-403286312/"
            >
              LinkedIn
            </a>
          </div>
        ...
        {/* Right Image */}
        <div className="w-full pt-20 md:w-1/2 flex justify-center relative">
          <img
            src={heroImage}
            alt="Hero"
